...
- Les artistes essayent de créer une expérience entre les animaux et l'humain pour représenter le lien universel qui nous rassemble. Au travers des regards, l'utilisateur est invité à observer les regards animal projetés ainsi qui le sien créant un dialogue visuel.
  L'oeuvre tente d'établir un lien profond entre l'Homme et l'Animal;

![photo](photo/cartel.jpg)
> Cartel de l'oeuvre Photo : Zara Lanthier

- En circulant autour du dispositif, on remarque les regards de animaux, mais ce n'est que lorsque l'on entre dans un zone mise en valeur par un cercle de lumière ainsi que des icons de pas que l'intéraction s'active. Nos yeux sont projetés dans les divers écrans. L'ambiance sonore s'intensifie et on entend divers bruits nous plongeants dans une atmosphère mélancolique;
...
- Éléments nécessaires à la mise en exposition: Télévision cathodique, caméras Sony A6500, raspberry Pi avec écran, mediapipe;
- Des haut-parleurs, des lumières LED, des spotlights, du câblage et de la décoration (fleurs et plantes artificielles) ont aussi été utilisé;
